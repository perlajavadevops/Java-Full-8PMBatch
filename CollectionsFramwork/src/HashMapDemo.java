...
public class HashMapDemo {
	...
	//	TreeMap<String, String>  map = new TreeMap<String, String>();
		...
		*/
		...
		Set<Entry<String,Employee>> set = map.entrySet();//it will convert map to Set

		Iterator<Entry<String,Employee>> itr = set.iterator();
		while(itr.hasNext()){
			Entry<String,Employee> entries = itr.next();
